...
import {
  QUERY_DASHBOARD_WALKTHROUGH_STEPS,
  QUERY_DASHBOARD_WALKTHROUGH_STORAGE_KEY,
  type QueryDashboardWalkthroughPlacement,
  type QueryDashboardWalkthroughStep,
  type QueryDashboardWalkthroughStepId,
} from "./query-dashboard-walkthrough-config";
...
const WALKTHROUGH_STEPS = QUERY_DASHBOARD_WALKTHROUGH_STEPS;
const WALKTHROUGH_STORAGE_KEY = QUERY_DASHBOARD_WALKTHROUGH_STORAGE_KEY;

type QueryDashboardWalkthroughProps = {
  enabled: boolean;
  onActiveStepChange?: (stepId: QueryDashboardWalkthroughStepId | null) => void;
};
...
function getStepTarget(step: QueryDashboardWalkthroughStep) {
...
export function QueryDashboardWalkthrough({
  enabled,
  onActiveStepChange,
}: QueryDashboardWalkthroughProps) {
  ...
  const titleId = `query-dashboard-walkthrough-${activeStep.id}-title`;
  const bodyId = `query-dashboard-walkthrough-${activeStep.id}-body`;
...
export default QueryDashboardWalkthrough;
