...
export function KanbanColumn({
  ...
  return (
    <div className={cn("flex flex-col w-[272px] min-w-[272px] md:h-[calc(100vh-120px)] h-full min-h-0", className)}>
      ...
      <div
        ref={mergedRef}
        className={cn(
          "flex flex-1 min-h-0 flex-col gap-2 p-2 bg-accent/10 rounded-lg max-sm:overscroll-contain overflow-y-auto md:scrollbar-transparent",
