  ...
  return (
    <>
      <div className="w-full md:w-3/4 mx-auto flex flex-col items-center pt-16">
        <h1 className="text-[24px] md:text-[32px] mb-8 font-semibold leading-tight text-center text-accent">
        ...
        <div className="flex flex-col md:flex-row gap-8 mt-8 w-full justify-center">
          <Link href="/smart-match">
            <Button className="cursor-pointer text-base p-8 font-semibold w-full md:w-auto shadow-lg hover:shadow-xl">
              Smart Match
            </Button>
          </Link>
