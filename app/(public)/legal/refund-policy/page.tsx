...
const PAGE_PATH = "/legal/refund-policy";
const PAGE_URL = absoluteUrl(PAGE_PATH);
const PAGE_TITLE = "Refund Policy";
const PAGE_DESCRIPTION =
  "Refund and cancellation terms for Write Query Hook subscriptions. All sales are final, but we care about your experience — here is how we handle issues.";
